...
pairTrait_twoStep_likelihood_multiple_model <- function(theta,betXY,pi1,sig1,w8s,m0,pi_U=0.1,pi_X,pi_Y,i_X,i_Y,nX,nY,model="full",bn=2^8,bins=15,M=1e7){
